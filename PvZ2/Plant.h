...
static_assert(sizeof(BoardEntity) == 0x80);
static_assert(sizeof(PlantGroup) == 168);
static_assert(offsetof(PlantGroup, m_gridX) == 0x80);
static_assert(offsetof(PlantGroup, m_gridY) == 0x84);
static_assert(offsetof(PlantGroup, m_plants) == 0x90);
