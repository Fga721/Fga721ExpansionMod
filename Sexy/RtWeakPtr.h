...
namespace Sexy
{
    ...
    public:
        ...
        ~RtWeakPtr()
        {
            ...
            setWeakPtr setWeakPtrFunc = (setWeakPtr)Fga721GetActualOffset(OFFSET_RTWEAKPTR_SETWEAKPTR);
        ...
        RtWeakPtr(RtWeakPtr&& other) {
            ...
            weakPtrMove weakPtrMoveFunc = (weakPtrMove)Fga721GetActualOffset(OFFSET_RTWEAKPTR_MOVE);
        ...
        RtWeakPtr(const RtWeakPtr& other) {
            ...
            weakPtrFromOther weakPtrFromOtherFunc = (weakPtrFromOther)Fga721GetActualOffset(OFFSET_RTWEAKPTR_FROMOTHER);
        ...
        bool operator==(const RtWeakPtr<T>& other) const
        {
            ...
            equalsOther equalsOtherFunc = (equalsOther)Fga721GetActualOffset(OFFSET_RTWEAKPTR_EQUALS);
        ...
        bool IsValid()
        {
            ...
            func pFunc = (func)Fga721GetActualOffset(OFFSET_RTWEAKPTR_ISVALIDPTR);
            return pFunc(this);
        }
        ...
        void FromOther(RtWeakPtr* other)
        {
            ...
            func pSetValue = (func)Fga721GetActualOffset(OFFSET_RTWEAKPTR_FROMOTHER);
        ...
        T* Get()
        {
            ...
            RtWeakPtrGet funcRtWeakPtrGet = (RtWeakPtrGet)Fga721GetActualOffset(0x5E0AF4);
