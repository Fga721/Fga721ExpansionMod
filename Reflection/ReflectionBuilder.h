...
#define RT_CLASS_CONSTRUCT_FUNCTION(className, baseCtorAddr) \
    ...
    { \
        ...
        ctorWithThisPtr baseCtor = (ctorWithThisPtr)Fga721GetActualOffset(baseCtorAddr); \
        baseCtor(instance); \
...
#define RT_CLASS_CONSTRUCT_FUNCTION_WITH_TI(className, baseCtorAddr, typeInfoAddr) \
    ...
    { \
        ...
        baseCtor(instance); \
        SetVFTable(instance, (uintptr_t)vftable); \
        ((int*)instance)[4] = Fga721GetActualOffset(typeInfoAddr); \
        return instance; \
    }
...
#define RT_CLASS_GET_CLASS_FUNCTION(className, parentGetTypeAddr) \
    ...
    { \
        ...
        { \
            ...
            s_rtClass = rtClass; \
            rtClassGetClassFunc parentGetType = (rtClassGetClassFunc)Fga721GetActualOffset(parentGetTypeAddr); \
...
#define RT_CLASS_GET_CLASS_WRAPPER(getTypeAddr) \
    ...
    { \
        ...
        getType pGetType = (getType)Fga721GetActualOffset(getTypeAddr); \
        return pGetType(); \
    } 
